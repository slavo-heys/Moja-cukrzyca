...
def pomiar_miesiaca():
    ...
    def pokaz_pomiary():
        ...
        records = c.fetchall()
        for rec in records:
            wynik.insert(INSERT,str(rec[1])+"/"+str(rec[2])+"/"+str(rec[3])+"  "+str(rec[4])+":"+str(rec[5])+"    "+str(rec[6])+"   "+str(rec[7])+"\n")
    ...
    zap=ttk.Combobox(ramk1, textvariable=miesiacZap, font = ("Arial", 13), width = 12)
    zap['values'] = ("Styczeń", "Luty", "Marzec", "Kwiecień", "Maj", "Czerwiec", "Lipiec", "Sierpień", "Wrzesień", "Pażdziernik", "Listopad", "Grudzień")
    zap.current(0)
...
def rejestracja_lekarza():
    ...
    def formularz():
        ...
        lin1 = tk.Label(ram1, text="Imie lekarza: ", font=("Arial",13), fg="blue")
        lin2 = tk.Label(ram1, text="Nazwisko lekarza: ", font=("Arial",13), fg="blue")
        lin3 = tk.Label(ram1, text="Specjalizacja: ", font=("Arial",13), fg="blue")
        ...
        lin6 = tk.Label(ram3, text="Przychodnia: ", font=("Arial",13), fg="blue")
    ...
    row = records[0]
    if row > 0:
        result = messagebox.askquestion("Pytanie?", "Lekarz już istnieje, czy chcesz wprowadzić nowego użytkownika?", icon="warning")
        if result == "yes":
            formularz()
        else:
            return
...
def rejestracja_uzytkownika():
    ...
    row = records[0]
    if row > 0:
        result = messagebox.askquestion("Pytanie", "Użytkownik już istnieje, czy chcesz wprowadzić nowego użytkownika?", icon="warning")
        if result == "yes":
                
            ramkaNowyUser = LabelFrame(root, text = "Nowy użytkownik", padx=5, pady =5)
            ...
            ramkaNowyUser_3 = LabelFrame(ramkaNowyUser, text = "Adres zamieszkania", padx=5, pady=5)
            ...
            li1=tk.Label(ramkaNowyUser_1, text = "Imie: ", font=("Arial", 13), fg = "green")
            li2=tk.Label(ramkaNowyUser_1, text = "Nazwisko: ", font=("Arial", 13), fg = "green")
            li1.grid(row=0, column=0, sticky=W)
            li2.grid(row=1, column=0, sticky=W)

            li3=tk.Label(ramkaNowyUser_2, text = "Urodzony: ", font=("Arial", 13), fg = "green")
            li3.grid(row=0, column=0, sticky=W)

            li5=tk.Label(ramkaNowyUser_3, text = "ulica: ", font=("Arial", 13), fg = "green")
            li6=tk.Label(ramkaNowyUser_3, text = "nr ulicy: ", font=("Arial", 13), fg = "green")
            li7=tk.Label(ramkaNowyUser_3, text = "nr mieszkania: ", font=("Arial", 13), fg = "green")
            li8=tk.Label(ramkaNowyUser_3, text = "kod: ", font=("Arial", 13), fg = "green")
            li9=tk.Label(ramkaNowyUser_3, text = "miasto: ", font=("Arial", 13), fg = "green")
            ...
            li10=tk.Label(ramkaNowyUser_4, text = "Telefon: ", font=("Arial", 13), fg = "green")
            li11=tk.Label(ramkaNowyUser_4, text = "Email: ", font=("Arial", 13), fg = "green")
            li10.grid(row=0, column=0, sticky=W)
            li11.grid(row=1, column=0, sticky=W)

            li12=tk.Label(ramkaNowyUser_5, text = "Rodzaj cukrzycy: ", font=("Arial", 13), fg = "green")
            li13=tk.Label(ramkaNowyUser_5, text = "Waga: ", font=("Arial", 13), fg = "green")
            li14=tk.Label(ramkaNowyUser_5, text = "Wzrost: ", font=("Arial", 13), fg = "green")
            li12.grid(row=0, column=0, sticky=W)
            li13.grid(row=1, column=0, sticky=W)
            li14.grid(row=2, column=0, sticky=W)

            li20=tk.Label(ramkaNowyUser_5, text = "kg", font=("Arial", 13), fg = "green")
            li21=tk.Label(ramkaNowyUser_5, text = "cm", font=("Arial", 13), fg = "green")
            ...
            en3=tk.Spinbox(ramkaNowyUser_2, from_ = 1, to = 31, textvariable = dzien_ins, font=("Arial", 13), width = 4)
            en4=ttk.Combobox(ramkaNowyUser_2, textvariable=miesiac_ins, font = ("Arial", 13), width = 12)
            en4['values'] = ("Styczeń", "Luty", "Marzec", "Kwiecień", "Maj", "Czerwiec", "Lipiec", "Sierpień", "Wrzesień", "Pażdziernik", "Listopad", "Grudzień")
            en4.current(1)
            en5=tk.Spinbox(ramkaNowyUser_2, from_ = 1960, to = 2020, textvariable= rok_ins, font=("Arial", 13), width= 4)
            ...
            en13=tk.Spinbox(ramkaNowyUser_5, from_=1, to =2, textvariable = rodzCukrzycy_ins, font=("Arial", 13), width = 2)
            en14=tk.Spinbox(ramkaNowyUser_5, from_ = 1, to = 180, textvariable = waga_ins, font=("Arial", 13), width = 4)
            en15=tk.Spinbox(ramkaNowyUser_5, from_=1, to = 230, font=("Arial", 13), textvariable = wzrost_ins, width = 4)
            en13.grid(row = 0, column = 1, sticky=W)
            en14.grid(row = 1, column = 1, sticky=W)
            en15.grid(row = 2, column = 1, sticky=W)

            bu1=tk.Button(ramkaNowyUser_6, text = "Zapisz dane", command=zapisz_usera)
            bu2=tk.Button(ramkaNowyUser_6, text = "Wyczyść pola", command=wyczysc_usera)
            bu3=tk.Button(ramkaNowyUser_6, text = "Zamknij okno", command=zamknij_usera)
...
def add_poziomy():
    ...
    l1 = tk.Label(ramka_poziomy, text = "data: ", font = ("Arial", 13, "bold"), fg = "green")
    l2 = tk.Label(ramka_poziomy, text = "godzina: ", font = ("Arial", 13, "bold"), fg = "green")
    l3 = tk.Label(ramka_poziomy, text = "pora dnia: ", font = ("Arial", 13, "bold"), fg = "green")
    l4 = tk.Label(ramka_poziomy, text = "wpisz poziom: ", font = ("Arial", 13, "bold"), fg = "green")
    l1.grid(row = 0, column = 0, sticky = W)
    l2.grid(row = 0, column = 2, sticky = W)
    l3.grid(row = 0, column = 4, sticky = W)
    l4.grid(row = 0, column = 6, sticky = W)

    l5 = tk.Label(ramka_poziomy, text = dzien+"-"+miesiac+"-"+rok, font=("arial", 13), fg="green")
    l6 = tk.Label(ramka_poziomy, text = godzina+":"+minuta, font=("arial", 13), fg="green")
    l5.grid(row=0, column=1, sticky=W)
    l6.grid(row=0, column=3, sticky=W)

    poraDnia = StringVar()
    suwak = ttk.Combobox(ramka_poziomy, textvariable=poraDnia)
    suwak['values']= ("Przed śniadaniem", "Po śniadaniu", "Przed obiadem", "Po obiedzie", "Przed kolacją", "Po kolacji", "Pomiar dodatkowy")
    suwak.current(0)
    ...
    b1= tk.Button(ramka_poziomy, text = "Zapisz wynik", fg="red", command=lambda:zapisz_pomiar(dzien, miesiac, rok, godzina, minuta))
    b2= tk.Button(ramka_poziomy, text = "Zamknij to okno", command=ramka_poziomy.destroy)
...
def MenuRozwijane():
    ...
    new_item.add_command(label="rejestracja użytkownika", command=rejestracja_uzytkownika)
    new_item.add_separator()
    new_item.add_command(label="rejestracja lekarza", command=rejestracja_lekarza)
    ...
    new_obsl.add_command(label="sprawdź pomiar z miesiąca", command=pomiar_miesiaca)
    new_obsl.add_separator()
    new_obsl.add_command(label="sprawdź wszystkie pomiary", command="")
    new_obsl.add_separator()
